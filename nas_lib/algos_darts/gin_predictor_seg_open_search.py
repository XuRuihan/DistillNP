...
def gin_predictor_seg_search_open(search_space,
                              algo_info,
                              logger,
                              gpus,
                              save_dir,
    ...
    darts_neural_dict = search_space.assemble_voc_neural_net(data_dict)
    ...
    while query <= total_queries:
        ...
        darts_candidate_neural_dict = search_space.assemble_voc_neural_net(temp_candidate_train_arch)
